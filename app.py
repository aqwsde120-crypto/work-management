...
def init_db():
    ...
    if c.fetchone()[0] == 0:
        # 샘플 데이터 삽입
        sample_tasks = [
            ('2024 마케팅 캠페인', 'Q1 디지털 광고 전략 수립', 'Google Ads 및 Meta 광고 캠페인 기획', '김팀장,이대리', 'MD #1', '진행 중', 75, 68, 85, '2024-05-15', 1),
            ('신제품 출시', 'MVP 개발 완료', '핵심 기능 3가지 구현 및 테스트', '박사원,최인턴', 'MD #2', '진행 중', 60, 72, 90, '2024-04-30', 1),
            ('고객 만족도 개선', 'CS 프로세스 리뉴얼', '고객 응대 매뉴얼 업데이트 및 교육', '정주임', 'GTM', '완료', 100, 100, 100, '2024-03-20', 1),
            ('데이터 분석 시스템', '대시보드 구축', 'Tableau 기반 실시간 모니터링 대시보드', '윤대리,한주임', 'MD #1', '검토 중', 90, 85, 94, '2024-05-01', 0),
            ('파트너십 확대', 'B2B 제휴 협상', '주요 3개사와 MOU 체결', '김팀장', 'GTM', '일정 지연', 50, 30, 40, '2024-04-10', 0),
            ('내부 시스템 개선', 'ERP 시스템 업그레이드', '재고관리 모듈 최적화', '박사원', 'MD #2', '진행 중', 45, 50, 70, '2024-06-01', 1),
            ('브랜드 리뉴얼', 'CI/BI 디자인 개발', '새로운 브랜드 아이덴티티 수립', '이대리,정주임', 'MD #1', '진행 중', 80, 75, 88, '2024-05-20', 1),
            ('글로벌 확장', '해외 시장 조사', '동남아 3개국 시장 분석 보고서', '윤대리', 'GTM', '완료', 100, 100, 100, '2024-03-25', 1),
            ('보안 강화', '정보보호 인증 취득', 'ISO 27001 인증 준비', '한주임,최인턴', 'MD #2', '진행 중', 55, 60, 75, '2024-07-15', 0),
            ('직원 교육', 'AI 활용 워크샵', '전사 ChatGPT 활용 교육 프로그램', '김팀장,정주임', 'GTM', '검토 중', 70, 65, 80, '2024-04-25', 1),
        ]
